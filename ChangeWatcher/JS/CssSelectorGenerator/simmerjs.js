(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.SimmerJS = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
...
},{"lodash.takeright":4}],7:[function(require,module,exports){
'use strict';
...
},{"./inspectElementID":8,"./inspectNthChild":9,"./inspectSiblings":10,"./inspectSpecialAttributes":11,"./inspectTags":12}],8:[function(require,module,exports){
'use strict';
...
},{"../queryEngine":15,"./validationHelpers":13}],9:[function(require,module,exports){
'use strict';
...
},{"lodash.difference":1,"lodash.flatmap":2}],10:[function(require,module,exports){
'use strict';
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./validationHelpers":13,"lodash.take":3}],11:[function(require,module,exports){
'use strict';
...
var _validationHelpers = require('./validationHelpers');
},{"./validationHelpers":13}],13:[function(require,module,exports){
'use strict';
...
},{"./configuration":5,"./convertSelectorStateIntoCSSSelector":6,"./methods":7,"./parser":14,"./queryEngine":15,"./stackHierarchy":17,"./validateSelector":18}],17:[function(require,module,exports){
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./convertSelectorStateIntoCSSSelector":6}],19:[function(require,module,exports){
"use strict";

var _simmerjs = _interopRequireDefault(require("simmerjs"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

function getSelector(el) {
  var simmer = new _simmerjs["default"](window, {
    depth: 10
  });
  return simmer(el);
}
